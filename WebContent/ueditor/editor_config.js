...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","cleardoc","preview","template","bold","italic","underline","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","removeformat","pasteplain","fontfamily","fontsize","paragraph","rowspacingbottom","rowspacingtop","lineheight","inserttable"]]
